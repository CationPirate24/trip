...
<html lang="en">
  <head>
    ...
    <script type="text/javascript">
		function add(){
			window.location.href = "hotelManager/toAdd.do";
		}
		function lb(){
			window.location.href = "hotelManager/toList.do";
		}
		function cx(){
    ...
    <div class="templatemo-flex-row">
      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div id="myDiv">
          	<form action="hotelManager/toList.do" method="post" id="myForm1">
	          	<table>
	          		<tr>
	          			<td>
          ...
          <div class="templatemo-content-widget no-padding">
            <div class="panel panel-default table-responsive">
              <table class="table table-striped table-bordered templatemo-user-table">
                <thead>
                  <tr>
                    <td width="10%"><a href="" class="white-text templatemo-sort-by">酒店名<span class="caret"></span></a></td>
                    <td width="9%"><a href="" class="white-text templatemo-sort-by">价格<span class="caret"></span></a></td>
                    <td width="60%"><a href="" class="white-text templatemo-sort-by">描述<span class="caret"></span></a></td>
                    <td width="10%"><a href="" class="white-text templatemo-sort-by">酒店类型<span class="caret"></span></a></td>
                ...
                <tbody>
                  <c:forEach items="${hvList}" var="hv">
	                  <tr>
						...
						<td>${hv.typeVo}</td>
	                    <td>
							<form id="myFormFind<%=count%>" action="hotelManager/toFind.do" method="post">
								<input type="hidden" name="id" value="${hv.id}"/>
							</form>
	                    	<a href="javascript:void(0)" onclick="find('<%=count%>')" class="templatemo-edit-btn">查看</a>
	                    
							<form id="myFormUpdate<%=count%>" action="hotelManager/toUpdate.do" method="post">
								<input type="hidden" name="id" value="${hv.id}"/>
							</form>
	                    	<a href="javascript:void(0)" onclick="update('<%=count%>')" class="templatemo-edit-btn">修改</a>
	                    
							<form id="myFormDelete<%=count%>" action="hotelManager/delete.do" method="post">
								<input type="hidden" name="id" value="${hv.id}"/>
							</form>
          ...
          <div class="pagination-wrap">
            <ul class="pagination">
              ...
              <li><a href="hotelManager/toList.do?currentPage=1">首页</a></li>
    		 ...
    		 %>
    		  ...
    		  %>
    		  <li><a href="hotelManager/toList.do?currentPage=<%=currentPage-1%>">上一页</a></li>
    		  <%
    		  	}
    		   %>
    		...
    		<%
    		 ...
    		 <%
    		  ...
    		  %>
    		  	<li><a href="hotelManager/toList.do?currentPage=<%=currentPage+1%>&con=${con}">下一页</a></li>
    		  <%
    		  	}
    		   %>
              <li><a href="hotelManager/toList.do?currentPage=<%=pageCount%>">尾页</a></li>
