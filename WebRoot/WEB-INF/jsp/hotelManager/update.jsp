	...
	<script type="text/javascript">
		function jz(){
			...
			for(var i=0;i<typeArr.length;i++){
				if("${hotel.type}".indexOf(typeArr[i].value)!=-1){
					typeArr[i].checked = "checked";
				}
			}
			
			var myCityArr = document.getElementsByName("my_city_id");
			for(var i=0;i<myCityArr.length;i++){
				if(myCityArr[i].value=="${hotel.my_city_id}"){
      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            <h2 class="margin-bottom-10">修改酒店信息</h2>
            <p>Here goes another form and form controls.</p>
            <form action="hotelManager/update.do" class="templatemo-login-form" method="post" enctype="multipart/form-data">
              <input type="hidden" name="id" value="${hotel.id}"/>
              <input type="hidden" name="myCityId" value="${hotel.my_city_id}"/>
              <div class="row form-group">
                <div class="col-lg-12 has-success form-group">                  
                    <label class="control-label" for="inputWithSuccess">请输入酒店名：</label>
                    <input type="text" class="form-control" id="inputWithSuccess" name="name" value="${hotel.name}">
                </div>
              </div>
              <div class="row form-group">
                <div class="col-lg-12 has-warning form-group">                  
                    <label class="control-label" for="inputWithWarning">请输入价格：</label>
                    <input type="text" class="form-control" id="inputWithWarning" name="price" value="${hotel.price}">
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-lg-12 form-group">                   
                    ...
                    <textarea class="form-control" id="inputNote" rows="3" name="describe">${hotel.describe}</textarea>
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group"> 
                  ...
                  <img src="/pic/${hotel.picture_id}" width="300px" height="200px"/>
                </div>
                <div class="col-lg-6 col-md-6 form-group">
                  <div>
                    <label class="control-label templatemo-block">地图</label> 
                    <img src="/pic/${hotel.map_id}" width="300px" height="200px"/>                    
                  </div>                  
                </div> 
              </div>
              <div class="row form-group">
                <div class="col-lg-12">
                  <label class="control-label templatemo-block">上传酒店图片</label>
