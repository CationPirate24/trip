      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            ...
            <form action="interest/update.do" class="templatemo-login-form" method="post" enctype="multipart/form-data">
              <input type="hidden" name="id" value="${mi.id}"/>
              <div class="row form-group">
                <div class="col-lg-12 has-success form-group">                  
                    <label class="control-label" for="inputWithSuccess">请输入景点名：</label>
                    <input type="text" class="form-control" id="inputWithSuccess" name="name" value="${mi.name}">
                </div>
              </div>
              <div class="row form-group">
                <div class="col-lg-12 has-warning form-group">                  
                    <label class="control-label" for="inputWithWarning">请输入门票价格：</label>
                    <input type="text" class="form-control" id="inputWithWarning" name="price" value="${mi.price}">
                </div>
              </div>
              <div class="row form-group">
                <div class="col-lg-12 has-error form-group">                  
                    <label class="control-label" for="inputWithError">请输入地址：</label>
                    <input type="text" class="form-control" id="inputWithError" name="address" value="${mi.address}">
                </div>
              </div>
              <div class="row form-group">
                <div class="col-lg-12 form-group">                   
                    <label class="control-label" for="inputNote">请输入景点描述：</label>
                    <textarea class="form-control" id="inputNote" rows="3" name="describe">${mi.describe}</textarea>
                </div>
              </div>
                ...
                <div class="col-lg-12 form-group">
                	<c:forEach items="${cList}" var="c">            
	                    <div class="margin-right-15 templatemo-inline-block">
	                      <input type="checkbox" name="interestType" id="c<%=count%>" value="${c.myKey}"/>
	                      							   
	                      <label for="c<%=count++%>" class="font-weight-400"><span></span>${c.myValue}</label>
	                    </div>
                    </c:forEach>
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-lg-12 form-group">  
                	<c:forEach items="${myCityList}" var="mc">                 
	                    <div class="margin-right-15 templatemo-inline-block">
	                      <input type="radio" name="myCityId" id="r<%=count2%>" value="${mc.id}">
              ...
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group"> 
                  <label class="control-label templatemo-block">景点图片</label>                 
                  <img src="/pic/${mi.pictureId}" width="300px" height="200px"/>
                </div>
                <div class="col-lg-6 col-md-6 form-group">
                  <div>
                    <label class="control-label templatemo-block">地图</label> 
                    <img src="/pic/${mi.mapId}" width="300px" height="200px"/>                    
                  </div>                  
                </div> 
              </div>
              <div class="row form-group">
                <div class="col-lg-12">
                  <label class="control-label templatemo-block">上传景点图片</label>
                  <input type="file" name="pictureId" id="fileToUpload" class="filestyle" data-buttonName="btn-primary" data-buttonBefore="true" data-icon="false">
                  <label class="control-label templatemo-block">上传地图</label>
                  <input type="file" name="mapId" id="fileToUpload2" class="filestyle" data-buttonName="btn-primary" data-buttonBefore="true" data-icon="false">
                  <p>图片内存不能超过5M.</p>                  
                </div>
              </div>
