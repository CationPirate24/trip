      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            <h2 class="margin-bottom-10">添加景点</h2>
            <p>Here goes another form and form controls.</p>
            <form action="interest/add.do" class="templatemo-login-form" method="post" enctype="multipart/form-data">
              ...
              <div class="row form-group">
                <div class="col-lg-12 has-error form-group">                  
                    ...
                    <input type="text" class="form-control" id="inputWithError" name="address">
                </div>
              </div>
              <div class="row form-group">
