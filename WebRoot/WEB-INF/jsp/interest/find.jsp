      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            <h2 class="margin-bottom-10">查看景点</h2>
            <p>Here goes another form and form controls.</p>
            <form action="interest/find.do" class="templatemo-login-form" method="post">
              
              <div class="row form-group">
                <div class="col-lg-12 has-success form-group">                  
                    <label class="control-label" for="inputWithSuccess">景点名：${mi.name}</label>
                </div>
              </div>
              <div class="row form-group">
                <div class="col-lg-12 has-warning form-group">                  
                    <label class="control-label" for="inputWithWarning">门票价格：${mi.price}</label>
                </div>
              </div>
              <div class="row form-group">
                <div class="col-lg-12 has-error form-group">                  
                    <label class="control-label" for="inputWithError">地址：${mi.address}</label>
                </div>
              </div>
              <div class="row form-group">
                <div class="col-lg-12 form-group">                   
                    <label class="control-label" for="inputNote">景点描述：${mi.describe}</label>
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-lg-12 has-success form-group">                   
                    <div class="margin-right-15 templatemo-inline-block">
                      <label class="control-label" for="inputWithSuccess">景点类型：${types}</label>
                    </div>
                </div>
              </div>
