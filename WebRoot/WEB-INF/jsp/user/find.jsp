      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            <h2 class="margin-bottom-10">查看目的地</h2>
            <p>Here goes another form and form controls.</p>
            <form action="user/find.do" class="templatemo-login-form" method="post">
              
              <div class="row form-group">
                <div class="col-lg-12 has-success form-group">                  
                    <label class="control-label" for="inputWithSuccess">城市名：${myCity.name}</label>
                </div>
              </div>
              
              <div class="row form-group">
                <div class="col-lg-12 form-group">                   
                    <label class="control-label" for="inputNote">城市描述：${myCity.describe}</label>
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group"> 
                  ...
                  <img src="/pic/${myCity.picture_id}" width="300px" height="200px"/>
                </div>
                <div class="col-lg-6 col-md-6 form-group">
                  <div>
                    <label class="control-label templatemo-block">地图</label> 
                    <img src="/pic/${myCity.map}" width="300px" height="200px"/>                    
                  </div>                  
                </div> 
              </div>
