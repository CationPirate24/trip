...
<html lang="en">
  <head>
    ...
    <script type="text/javascript">
		function add(){
			window.location.href = "user/toAdd.do";
		}
		function lb(){
			window.location.href = "user/toList.do";
		}
		function cx(){
    ...
    <div class="templatemo-flex-row">
      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div id="myDiv">
          	<form action="user/toList.do" method="post" id="myForm1">
	          	<table>
	          		<tr>
	          			<td>
          ...
          <div class="templatemo-content-widget no-padding">
            <div class="panel panel-default table-responsive">
              <table class="table table-striped table-bordered templatemo-user-table">
                <thead>
                  <tr>
                    <td width="9%"><a href="" class="white-text templatemo-sort-by">城市名<span class="caret"></span></a></td>
          ...
          <div class="pagination-wrap">
            <ul class="pagination">
              ...
              <li><a href="user/toList.do?currentPage=1">首页</a></li>
    		 ...
    		 %>
    		  ...
    		  %>
    		  <li><a href="user/toList.do?currentPage=<%=currentPage-1%>">上一页</a></li>
    		  <%
    		  	}
    		   %>
    		...
    		<%
    		 ...
    		 <%
    		  ...
    		  %>
    		  	<li><a href="user/toList.do?currentPage=<%=currentPage+1%>&con=${con}">下一页</a></li>
    		  <%
    		  	}
    		   %>
              <li><a href="user/toList.do?currentPage=<%=pageCount%>">尾页</a></li>
