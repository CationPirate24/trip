...
<html lang="en">
  <head>
    ...
    <script type="text/javascript">
		function add(){
			window.location.href = "manager/toAdd.do";
		}
		function lb(){
			window.location.href = "manager/toList.do";
		}
		function cx(){
    ...
    <div class="templatemo-flex-row">
      <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">          
          <ul>
            <li><a href="#" class="active"><i class="fa fa-home fa-fw"></i>超级管理员</a></li>
      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div id="myDiv">
          	<form action="manager/toList.do" method="post" id="myForm1">
	          	<table>
	          		<tr>
	          			<%--<td>
          ...
          <div class="templatemo-content-widget no-padding">
            <div class="panel panel-default table-responsive">
              <table class="table table-striped table-bordered templatemo-user-table">
                <thead>
                  <tr>
                    <td width="15%"><a href="" class="white-text templatemo-sort-by">姓名<span class="caret"></span></a></td>
                    <td width="15%"><a href="" class="white-text templatemo-sort-by">年龄<span class="caret"></span></a></td>
                    <td width="15%"><a href="" class="white-text templatemo-sort-by">性别<span class="caret"></span></a></td>
                    <td width="25%"><a href="" class="white-text templatemo-sort-by">邮箱<span class="caret"></span></a></td>
                    <td width="18%"><a href="" class="white-text templatemo-sort-by">电话<span class="caret"></span></a></td>
                    <td width="12%"><a href="" class="white-text templatemo-sort-by">操作<span class="caret"></span></a></td>
                  </tr>
                </thead>
                <tbody>
                  <c:forEach items="${mmvList}" var="mmv">
	                  <tr>
	                    <td>${mmv.name}</td>
						<td>${mmv.age}</td>
						<td>${mmv.sexVo}</td>
						...
						<td>${mmv.phone}</td>
	                    <td>
							<form id="myFormFind<%=count%>" action="manager/toFind.do" method="post">
								<input type="hidden" name="id" value="${mmv.id}"/>
							</form>
	                    	<a href="javascript:void(0)" onclick="find('<%=count%>')" class="templatemo-edit-btn">查看</a>
	                    
							<form id="myFormUpdate<%=count%>" action="manager/toUpdate.do" method="post">
								<input type="hidden" name="id" value="${mmv.id}"/>
							</form>
	                    	<a href="javascript:void(0)" onclick="update('<%=count%>')" class="templatemo-edit-btn">修改</a>
	                    
							<form id="myFormDelete<%=count%>" action="manager/delete.do" method="post">
								<input type="hidden" name="id" value="${mmv.id}"/>
							</form>
          ...
          <div class="pagination-wrap">
            <ul class="pagination">
              ...
              <li><a href="manager/toList.do?currentPage=1">首页</a></li>
    		 ...
    		 %>
    		  ...
    		  %>
    		  <li><a href="manager/toList.do?currentPage=<%=currentPage-1%>">上一页</a></li>
    		  <%
    		  	}
    		   %>
    		...
    		<%
    		 ...
    		 <%
    		  ...
    		  %>
    		  	<li><a href="manager/toList.do?currentPage=<%=currentPage+1%>&con=${con}">下一页</a></li>
    		  <%
    		  	}
    		   %>
              <li><a href="manager/toList.do?currentPage=<%=pageCount%>">尾页</a></li>
