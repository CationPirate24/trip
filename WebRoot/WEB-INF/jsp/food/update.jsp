	...
	<script type="text/javascript">
		function jz(){
			...
			for(var i=0;i<typeArr.length;i++){
				if("${mf.type}".indexOf(typeArr[i].value)!=-1){
					typeArr[i].checked = "checked";
				}
			}
			
			var myCityArr = document.getElementsByName("address");
			for(var i=0;i<myCityArr.length;i++){
				if(myCityArr[i].value=="${mf.address}"){
      ...
      <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">
          <ul>
            ...
            <li><a href="#" class="active"><i class="fa fa-users fa-fw"></i>美食管理员</a></li>
      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            <h2 class="margin-bottom-10">修改美食信息</h2>
            <p>Here goes another form and form controls.</p>
            <form action="food/update.do" class="templatemo-login-form" method="post" enctype="multipart/form-data">
              <input type="hidden" name="id" value="${mf.id}"/>
              <input type="hidden" name="grade" value="${mf.grade}"/>
              <input type="hidden" name="myCityId" value="${mf.address}"/>
              <div class="row form-group">
                <div class="col-lg-12 has-success form-group">                  
                    <label class="control-label" for="inputWithSuccess">请输入美食：</label>
                    <input type="text" class="form-control" id="inputWithSuccess" name="name" value="${mf.name}">
                </div>
              </div>
              <div class="row form-group">
                <div class="col-lg-12 has-warning form-group">                  
                    <label class="control-label" for="inputWithWarning">请输入价格：</label>
                    <input type="text" class="form-control" id="inputWithWarning" name="price" value="${mf.price}">
                </div>
              </div>
              
              <div class="row form-group">
                <div class="col-lg-12 form-group">                   
                    <label class="control-label" for="inputNote">请输入描述：</label>
                    <textarea class="form-control" id="inputNote" rows="3" name="describe">${mf.describe}</textarea>
                </div>
              </div>
                ...
                <div class="col-lg-12 form-group">
                	<c:forEach items="${cList}" var="c">            
	                    <div class="margin-right-15 templatemo-inline-block">
	                      <input type="checkbox" name="type" id="c<%=count%>" value="${c.myKey}"/>
              ...
              <div class="row form-group">
                <div class="col-lg-12 form-group">  
                	<c:forEach items="${myCityList}" var="mc">                 
	                    <div class="margin-right-15 templatemo-inline-block">
	                      <input type="radio" name="address" id="r<%=count2%>" value="${mc.id}">
              ...
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group"> 
                  <label class="control-label templatemo-block">美食图片</label>                 
              ...
              <div class="row form-group">
                <div class="col-lg-12">
                  <label class="control-label templatemo-block">上传美食图片</label>
