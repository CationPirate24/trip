      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            <h2 class="margin-bottom-10">查看美食</h2>
            <p>Here goes another form and form controls.</p>
            <form action="food/find.do" class="templatemo-login-form" method="post">
              
              <div class="row form-group">
                <div class="col-lg-12 has-success form-group">                  
                    <label class="control-label" for="inputWithSuccess">美食：${mf.name}</label>
                </div>
              </div>
              <div class="row form-group">
                <div class="col-lg-12 has-warning form-group">                  
                    <label class="control-label" for="inputWithWarning">价格：${mf.price}</label>
                </div>
              
              <div class="row form-group">
                <div class="col-lg-12 form-group">                   
                    <label class="control-label" for="inputNote">描述：${mf.describe}</label>
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-lg-12 has-success form-group">                   
                    <div class="margin-right-15 templatemo-inline-block">
                      <label class="control-label" for="inputWithSuccess">类型：${foodTypes}</label>
                    </div>
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group"> 
                  ...
                  <img src="/pic/${mf.pictureId}" width="300px" height="200px"/>
                  <label class="control-label templatemo-block">地图</label>                 
                  <img src="/pic/${mf.mapId}" width="300px" height="200px"/>
                </div>
               </div>
