...
<div class="banner-bdy gal">
   <div class="container">
	<div id="gallery">
		 <p style="font-size: 25px;">&nbsp;&nbsp;&nbsp;&nbsp;您的游记已添加成功，先睹为快！！！</p><br>
		<div id="no1">
		<table width="100%">
    	<tr>
    	...
    	<tr>
    		<td align="center"><img src="/pic/${mt.picture_id}" width="650px" height="650px"></td>
    	</tr>
    	<tr><td>&nbsp;</td></tr>
    	<tr>
		...
		<div id="no11">
			<form action="myTravels/toList.do" method="post">
    			<input class="submit_3" type="submit" value="朕知道了">
    		</form>
