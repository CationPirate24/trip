		...
		<div class="container">
			<div class="row">
				<div class="tm-section-header section-margin-top">
					...
					<div class="col-lg-4 col-md-6 col-sm-6"><h2 class="tm-section-title">热门景点精选</h2></div>
					<div class="col-lg-4 col-md-3 col-sm-3"><hr></div>	
				</div>				
			</div>
			<div class="row">
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-xxs-12">
					<div class="tm-tours-box-2">
						...
						<div class="tm-tours-box-2-info">
							<h3 class="margin-bottom-15">故宫</h3>
							<img src="<%=basePath%>img9/rating.png" alt="image" class="margin-bottom-5">
							<p> 2016.10.11</p>	
						</div>
						<form id="interest1" action="<%=basePath%>home/foods/toInterestSelf.do" method="post">
							<input type="hidden" name="id" value="2cd2d1f99c564034b3124dca9b308c84"/>
						</form>	
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-xxs-12">
					<div class="tm-tours-box-2">						
						...
						<div class="tm-tours-box-2-info">
							<h3 class="margin-bottom-15">西湖</h3>
							<img src="<%=basePath%>img9/rating.png" alt="image" class="margin-bottom-5">
							<p>2016.10.11</p>	
						</div>	
						<form id="interest2" action="<%=basePath%>home/foods/toInterestSelf.do" method="post">
							<input type="hidden" name="id" value="54f298afbe83402182362c1fccba8db1"/>
						</form>					
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-xxs-12">
					<div class="tm-tours-box-2">						
						...
						<div class="tm-tours-box-2-info">
							<h3 class="margin-bottom-15">外滩</h3>
							<img src="<%=basePath%>img9/rating.png" alt="image" class="margin-bottom-5">
							<p>2016.10.11</p>	
						</div>
						<form id="interest3" action="<%=basePath%>home/foods/toInterestSelf.do" method="post">
							<input type="hidden" name="id" value="a31d51e225ee477fa62a1729eee1748e"/>
						</form>						
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-xxs-12">
					<div class="tm-tours-box-2">						
						...
						<div class="tm-tours-box-2-info">
							<h3 class="margin-bottom-15">天星小轮</h3>
							<img src="<%=basePath%>img9/rating.png" alt="image" class="margin-bottom-5">
							<p>2016.10.11</p>	
						</div>	
						<form id="interest4" action="<%=basePath%>home/foods/toInterestSelf.do" method="post">
							<input type="hidden" name="id" value="5b16d138bd62434a86c8001ab00586fa"/>
						</form>					
	...
	<section class="tm-grey-bg section-padding-bottom">
		<div class="container">
			<div class="row">
				<div class="tm-section-header section-margin-top">
					<div class="col-lg-4 col-md-3 col-sm-3"><hr></div>
					<div class="col-lg-4 col-md-6 col-sm-6"><h2 class="tm-section-title">热门酒店精选</h2></div>
					<div class="col-lg-4 col-md-3 col-sm-3"><hr></div>	
				</div>				
			</div>
			<div class="row">
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-xxs-12">
					<div class="tm-tours-box-2">
						<img src="<%=basePath%>img9/index-03.jpg" alt="image" class="img-responsive">
						<div class="tm-tours-box-2-info">
							<h3 class="margin-bottom-15">北京大方饭店</h3>
							<img src="<%=basePath%>img9/rating.png" alt="image" class="margin-bottom-5">
							<p> 2016.10.11</p>	
						</div>
						<form id="hotel1" action="<%=basePath%>home/foods/toHotelSelf.do" method="post">
							<input type="hidden" name="id" value="ef99fcfbd03c4e72ba87f7846a0d5662"/>
						</form>	
						<a href="javascript:void(0)" class="tm-tours-box-2-link" onclick="look1()">点我</a>
					</div>
				</div>
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-xxs-12">
					<div class="tm-tours-box-2">						
						<img src="<%=basePath%>img9/index-04.jpg" alt="image" class="img-responsive">
						<div class="tm-tours-box-2-info">
							<h3 class="margin-bottom-15">香港湾仔皇悦酒店</h3>
							<img src="<%=basePath%>img9/rating.png" alt="image" class="margin-bottom-5">
							<p>2016.10.11</p>	
						</div>	
						<form id="hotel2" action="<%=basePath%>home/foods/toHotelSelf.do" method="post">
							<input type="hidden" name="id" value="d52c9701b0054043b5a5dc2ab900bb79"/>
						</form>					
						<a href="javascript:void(0)" class="tm-tours-box-2-link" onclick="look2()">点我</a>
					</div>
				</div>
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-xxs-12">
					<div class="tm-tours-box-2">						
						<img src="<%=basePath%>img9/index-05.jpg" alt="image" class="img-responsive">
						<div class="tm-tours-box-2-info">
							<h3 class="margin-bottom-15">乐舒酒店</h3>
							<img src="<%=basePath%>img9/rating.png" alt="image" class="margin-bottom-5">
							<p>2016.10.11</p>	
						</div>
						<form id="hotel3" action="<%=basePath%>home/foods/toHotelSelf.do" method="post">
							<input type="hidden" name="id" value="c96c0d06f56e40da98260aaa1b65ee43"/>
						</form>						
						<a href="javascript:void(0)" class="tm-tours-box-2-link" onclick="look3()">点我</a>
					</div>
				</div>
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-xxs-12">
					<div class="tm-tours-box-2">						
						<img src="<%=basePath%>img9/index-06.jpg" alt="image" class="img-responsive">
						<div class="tm-tours-box-2-info">
							<h3 class="margin-bottom-15">杭州马可波罗酒店</h3>
							<img src="<%=basePath%>img9/rating.png" alt="image" class="margin-bottom-5">
							<p>2016.10.11</p>	
						</div>	
						<form id="hotel4" action="<%=basePath%>home/foods/toHotelSelf.do" method="post">
							<input type="hidden" name="id" value="679b53a806734d4cafe4c61132a18674"/>
						</form>					
						<a href="javascript:void(0)" class="tm-tours-box-2-link" onclick="look4()">点我</a>
					</div>
				</div>
		...
		<table align="center"  width="100%"  class="t">
				...
				<tr  height="30px">
					...
					<c:forEach items="${cList}" var="c">
						<td width="20%">
							<form id="myCity<%=i%>" action="<%=basePath%>home/foods/toHotelOfMyCity.do" method="post">
...
//	For images only
		...
		function look1(){
			document.getElementById("hotel1").submit();
		}
		function look2(){
			document.getElementById("hotel2").submit();
		}
		function look3(){
			document.getElementById("hotel3").submit();
		}
		function look4(){
			document.getElementById("hotel4").submit();
		}
	</script>
 </body>
 </html>