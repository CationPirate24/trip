	  			...
	  			<div class="col-lg-6 col-md-8 col-sm-9">
	  				...
	  				<nav class="tm-nav">
						<ul>
							...
							<li><a href="home/toInterestHome.do" class="active">景点</a></li>
		...
		<table align="center"  width="100%"  class="t">
				...
				<tr  height="30px">
					...
					<c:forEach items="${cList}" var="c">
						<td width="20%">
							<form id="myCity<%=i%>" action="<%=basePath%>home/interests/toInterestOfMyCity.do" method="post">
...
//	For images only
		...
		function look1(){
			document.getElementById("interest1").submit();
		}
		function look2(){
			document.getElementById("interest2").submit();
		}
		function look3(){
			document.getElementById("interest3").submit();
		}
		function look4(){
			document.getElementById("interest4").submit();
		}
	</script>
 </body>
 </html>