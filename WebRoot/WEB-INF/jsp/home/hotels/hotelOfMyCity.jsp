		...
		<div class="container">
			<div class="row">
				<div class="tm-section-header section-margin-top">
					...
					<div class="col-lg-4 col-md-6 col-sm-6"><h2 class="tm-section-title">${myCity.name}酒店</h2></div>
					<div class="col-lg-4 col-md-3 col-sm-3"><hr></div>	
				</div>				
			</div>
			<div class="row">
					...
					<div class="tm-what-we-do-right">
						...
						<div class="tm-about-box-2">
							...
							<div class="tm-about-box-2-text">
								<form id="myForm<%=count%>" action="home/hotels/toHotelSelf.do" method="post">
									<input type="hidden" name="id" value="${mh.id}"/>
								</form>
								<a href="javascript:void(0)" onclick="ck('<%=count%>')"><h3 class="tm-about-box-2-title">${mh.name}</h3></a>
								<table>
									<tr>
										<td>
				                ...
				                <a href="javascript:void(0)" onclick="ck('<%=count++%>')"><p class="tm-about-box-2-footer">RMB&nbsp;￥${mh.price}.00*</p></a>
							</div>                
						</div>
						</c:forEach>
					</div>
