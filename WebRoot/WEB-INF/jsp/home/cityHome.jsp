	  			...
	  			<div class="col-lg-6 col-md-8 col-sm-9">
	  				...
	  				<nav class="tm-nav">
						<ul>
							...
							<li><a href="home/toCityHome.do" class="active">城市</a></li>
		...
		<div class="container">
			<div class="row">
				<div class="tm-section-header section-margin-top">
					...
					<div class="col-lg-4 col-md-6 col-sm-6"><h2 class="tm-section-title">热门城市精选</h2></div>
					<div class="col-lg-4 col-md-3 col-sm-3"><hr></div>	
				</div>				
			</div>
			<div class="row">
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-xxs-12">
					<div class="tm-tours-box-2">
						...
						<div class="tm-tours-box-2-info">
							<h3 class="margin-bottom-15">北京</h3>
							<img src="<%=basePath%>img9/rating.png" alt="image" class="margin-bottom-5">
							<p> 2016.10.11</p>	
						</div>
						<form id="city1" action="<%=basePath%>home/toOneCity.do" method="post">
							<input type="hidden" name="id" value="b5835a41049d4d2592e556fcd11ea323"/>
						</form>	
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-xxs-12">
					<div class="tm-tours-box-2">						
						...
						<div class="tm-tours-box-2-info">
							<h3 class="margin-bottom-15">香港</h3>
							<img src="<%=basePath%>img9/rating.png" alt="image" class="margin-bottom-5">
							<p>2016.10.11</p>	
						</div>	
						<form id="city2" action="<%=basePath%>home/toOneCity.do" method="post">
							<input type="hidden" name="id" value="f40f852238d048d791dad5930836ff19"/>
						</form>					
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-xxs-12">
					<div class="tm-tours-box-2">						
						...
						<div class="tm-tours-box-2-info">
							<h3 class="margin-bottom-15">上海</h3>
							<img src="<%=basePath%>img9/rating.png" alt="image" class="margin-bottom-5">
							<p>2016.10.11</p>	
						</div>
						<form id="city3" action="<%=basePath%>home/toOneCity.do" method="post">
							<input type="hidden" name="id" value="8c1badef811b4a0fba901c6c3669ba60"/>
						</form>						
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-xxs-12">
					<div class="tm-tours-box-2">						
						...
						<div class="tm-tours-box-2-info">
							<h3 class="margin-bottom-15">杭州</h3>
							<img src="<%=basePath%>img9/rating.png" alt="image" class="margin-bottom-5">
							<p>2016.10.11</p>	
						</div>	
						<form id="city4" action="<%=basePath%>home/toOneCity.do" method="post">
							<input type="hidden" name="id" value="22af4c40b44c4bc589407ccdf383dab8"/>
						</form>					
		...
		<table align="center"  width="100%"  class="t">
				...
				<tr  height="30px">
					...
					<c:forEach items="${cList}" var="c">
						<td width="20%">
							<form id="myCity<%=i%>" action="<%=basePath%>home/toOneCity.do" method="post">
