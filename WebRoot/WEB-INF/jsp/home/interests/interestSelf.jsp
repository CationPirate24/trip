		...
		<div class="section-margin-top about-section">
			<div class="row">				
				<div class="tm-section-header">
					...
					<div class="col-lg-6 col-md-6 col-sm-6"><h2 class="tm-section-title">${mi.name}</h2></div>
					<div class="col-lg-3 col-md-3 col-sm-3"><hr></div>	
				</div>
			</div>
			<div class="row">
				...
				<div class="tm-about-box-2 margin-bottom-30">
					...
					<table>
						<tr>
							<td width="80%">
								<img src="/pic/${mi.pictureId}" width="300px" height="450spx" alt="image" class="tm-about-box-2-img">
								<div class="tm-about-box-2-text">
									...
									<form id="pinglun" action="comment/toCommentAdd.do" method="post">
										<input type="hidden" name="everyId" value="${mi.id}"/>
									</form>
							...
							<td width="20%">
								<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
									<a href="#"><img src="/pic/${mi.mapId}" width="250px" height="450spx" alt="img" class="tm-about-box-2-img"></a>
								</div>
							</td>
						</tr>
					</table>              
					...
					<div class="tm-about-box-2 margin-bottom-30">
						<table>
							<tr>
								...
								<td>
									<img src="/pic/${maa.pictureId}" width="300px" height="300spx" alt="image" class="tm-about-box-2-img">
								</td>
								<td>
									<div class="tm-about-box-2-text">
