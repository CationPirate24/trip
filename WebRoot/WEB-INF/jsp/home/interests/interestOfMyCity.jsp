		...
		<div class="container">
			<div class="row">
				<div class="tm-section-header section-margin-top">
					...
					<div class="col-lg-4 col-md-6 col-sm-6"><h2 class="tm-section-title">${myCity.name}景点</h2></div>
					<div class="col-lg-4 col-md-3 col-sm-3"><hr></div>	
				</div>				
			</div>
			<div class="row">
				...
				<div class="col-lg-12">
					<div class="tm-what-we-do-right">
						...
						<div class="tm-about-box-2">
							...
							<img src="/pic/${mi.pictureId}" width="300px" height="300spx" alt="image" class="tm-about-box-2-img">
							<div class="tm-about-box-2-text">
								<form id="myForm<%=count%>" action="home/interests/toInterestSelf.do" method="post">
									<input type="hidden" name="id" value="${mi.id}"/>
								</form>
								<a href="javascript:void(0)" onclick="ck('<%=count%>')"><h3 class="tm-about-box-2-title">${mi.name}</h3></a>
								<table>
									<tr>
										<td>
											<p class="tm-about-box-2-description gray-text">${mi.describe}</p>
										</td>
									</tr>
									<tr>
										<td>
				                ...
				                <a href="javascript:void(0)" onclick="ck('<%=count++%>')"><p class="tm-about-box-2-footer">RMB&nbsp;￥${mi.price}.00*</p></a>
							</div>                
						</div>
						</c:forEach>
					</div>
