		...
		<div class="section-margin-top about-section">
			<div class="row">				
				<div class="tm-section-header">
					...
					<div class="col-lg-6 col-md-6 col-sm-6"><h2 class="tm-section-title">${mf.name}</h2></div>
					<div class="col-lg-3 col-md-3 col-sm-3"><hr></div>	
				</div>
			</div>
			<div class="row">
						...
						<tr>
							<td width="80%">
								...
								<div class="tm-about-box-2-text">
									...
									<form id="pinglun" action="comment/toCommentAdd.do" method="post">
										<input type="hidden" name="everyId" value="${mf.id}"/>
									</form>
							...
							<td width="20%">
								<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
									<a href="#"><img src="/pic/${mf.mapId}" width="200px" height="200spx" alt="img" class="tm-about-box-2-img"></a>
								</div>
							</td>
						</tr>
					</table>              
