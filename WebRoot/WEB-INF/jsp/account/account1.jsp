...
function ckxx() {
	document.getElementById("myForm4").submit();
		...
		<script type="text/javascript">
function ck(count) {
	document.getElementById("myForm2" + count).submit();
}

function xg(count) {

	document.getElementById("myForm" + count).submit();
...
function sc(count) {
	var i = confirm("是否删除");
	if (i == true) {
		document.getElementById("myForm1" + count).submit();
	}
}
</script>
		<base href="<%=basePath%>">
		...
		<div class="app app-header-fixed" id="app">
								...
								<ul class="nav nav-sub dk">
									...
									<li ui-sref-active="active">
										<a ui-sref="layout.fullwidth"> <span><a
												href="account1/toUpdate.do">修改信息</a> </span> </a>
									</li>
									<li ui-sref-active="active">
										<a ui-sref="layout.fullwidth"> <span><a
												href="account1/toRecharge.do">充值</a> </span> </a>
									</li>
								...
								<ul class="nav nav-sub dk">
									...
									<li ui-sref-active="active">
										<a ui-sref="app.table.static"> <span
											translate="aside.nav.components.table.TABLE_STATIC"><a
												href="account1/toAccount.do"> 我的游记 
										</span> </a>
									</li>
									<li ui-sref-active="active">
										<a ui-sref="app.table.datatable"> <span
											translate="aside.nav.components.table.DATATABLE"><a
												href="account1/toComment.do">我的点评</a> </span> </a>
									</li>
						...
						<div class="col">
							...
							<div class="wrapper bg-white b-b">
								<ul class="nav nav-pills nav-sm">
									<li class="active">
										<a href=javascript:void(0)"">我的游记</a>

									</li>
									<li>
										<a href="myTravels/toAdd.do">添加游记</a>
									</li>
								</ul>
							</div>
							<div class="padder">
								<table id="table1">
									...
									<c:if test="${!empty mtlist}">
										<c:forEach items="${mtlist}" var="m">
											<tr style="height: 60px;">


												<td width="50%" class="td1">
													<a href="游记页面">${m.name}</a>

													<br />
													创建于:${m.time}

												</td>
												<td width="50%" align="left" class="td2">
													<form action="myTravels/toShow.do" method="post"
														id="myForm2<%=count%>">
														<input type="hidden" name="id" value="${m.id}" />
													</form>
													<form action="myTravels/toUpdate.do" method="post"
														id="myForm<%=count%>">
														<input type="hidden" name="id" value="${m.id}" />
													</form>
													<form action="myTravels/toDelete.do" method="post"
														id="myForm1<%=count%>">
														<input type="hidden" name="id" value="${m.id}" />
													</form>

													<a href="javascript:void(0)" onclick="ck('<%=count%>')">查看</a>&nbsp;&nbsp;
													<a href="javascript:void(0)" onclick="xg('<%=count%>')">修改</a>&nbsp;&nbsp;


													<a href="javascript:viod(0)" onclick="sc('<%=count++%>')">删除</a>
								...
								<div class="panel b-light clearfix">
									<div class="panel-body">
										<a href class="thumb pull-left m-r"> <img
												src="img3/a0.jpg" class="img-circle"> </a>
										<div class="clear">
							...
							<div class="cell-inner padder">
								...
								<div class="m-b">
									<a href class="pull-right thumb-xs avatar"><img
											src="img3/a3.jpg" class="img-circle" alt="..."> </a>
									<div class="clear">
			...
			<div class="app-footer wrapper b-t bg-light">
				<span class="pull-right">1.0.0 <a href="#app"
					class="m-l-sm text-muted"><i class="fa fa-long-arrow-up"></i> </a>
