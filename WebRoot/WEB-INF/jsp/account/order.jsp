          ...
          <li class="dropdown">
            <a href="#" data-toggle="dropdown" class="dropdown-toggle clear" data-toggle="dropdown">
              <span class="thumb-sm avatar pull-right m-t-n-sm m-b-n-sm m-l-sm">
                <img src="/pic/${ma.picture}" alt="...">
                <i class="on md b-white bottom"></i>
              </span>
              <span class="hidden-sm hidden-md">${ma.username}</span> <b class="caret"></b>
            </a>
            <!-- dropdown -->
            ...
            <ul class="nav">
                ...
                <ul class="nav nav-sub dk">
                  ...
                  <li ui-sref-active="active">
                    <a ui-sref="layout.app">
                       <span><a href="account1/toSee1.do">查看信息</a></span>
                    </a>
                  </li>
                  <li ui-sref-active="active">
                    <a ui-sref="layout.fullwidth">
                     <span><a href="account1/toUpdate.do">修改信息</a></span>
                    </a>
                  </li>
              ...
              <li ng-class="{active:$state.includes('app.ui')}">
                <a href class="auto">
                  ...
                  <span translate="aside.nav.components.ui_kits.UI_KITS">订单信息</span>
                </a>
                <ul class="nav nav-sub dk">
                  <li class="nav-sub-header">
                    <a href>
                  ...
                  <li ui-sref-active="active">
                    <a ui-sref="app.ui.buttons">
                      <span translate="aside.nav.components.ui_kits.BUTTONS">订单查询</span>
                    </a>
                  </li>        
              ...
              <li ng-class="{active:$state.includes('app.table')}">
                <a href class="auto">
                  ...
                  <span translate="aside.nav.components.table.TABLE">个人中心</span>
                </a>
                <ul class="nav nav-sub dk">
                  <li class="nav-sub-header">
                    <a href>
                  ...
                  <li ui-sref-active="active">
                    <a ui-sref="app.table.static">
                      <span translate="aside.nav.components.table.TABLE_STATIC">我的点评</span>
                    </a>
                  </li>
                  <li ui-sref-active="active">
                    <a ui-sref="app.table.datatable">
                      <span translate="aside.nav.components.table.DATATABLE">我的游记</span>
                    </a>
                  </li>
            ...
            <div class="col">
                  ...
                  <div class="row m-t">
                    <div class="col-sm-7">
                      <a href class="thumb-lg pull-left m-r">
                        <img src="/pic/${ma.picture}" class="img-circle">
                      </a>
                      <div class="clear m-b">
              ...
              <div class="padder">      
                <table width="850px" id="table1">
					<tr>
						<td>
						<input type="hidden" value="${ma.id}" name="accountid" /><!-- 用于读取客户id -->
						</td>
