			...
			<div class="app-header navbar">
				...
				<div class="navbar-header bg-dark">
					...
					<a href="#/" class="navbar-brand text-lt"> <i class="fa fa-btc"></i>
						...
						class="hidden-folded m-l-xs">My TRIP</span> </a>
					<!-- / brand -->
				</div>
				<!-- / navbar header -->
						...
						<ul class="nav">
							...
							<li>
								...
								<ul class="nav nav-sub dk">
									...
									<li ui-sref-active="active">
										<form action="account1/toSee1.do" method="post" id="myForm2">

											<input type="hidden" name="accountid" value="${ma.id}" />
										</form>
										<a ui-sref="layout.app"> <span><a
												href="javascript:void(0)" onclick="ck()">查看信息</a> </span> </a>
							...
							<li ng-class="{active:$state.includes('app.table')}">
								...
								<ul class="nav nav-sub dk">
									...
									<li ui-sref-active="active">
										<form action="account1/toAccount.do" method="post"
											id="myForm5">
										...
										<a ui-sref="layout.app"> <span><a
												href="javascript:void(0)" onclick="youji()">我的游记</a> </span> </a>
									</li>
					...
					<div class="hbox hbox-auto-xs hbox-auto-sm">
						<div class="col">
							...
							<div class="padder" align="center">
								<form action="account1/update.do" method="post"
									enctype="multipart/form-data">
									<input type="hidden" value="${ma.id}" name="accountid" />
									<!-- 用于读取客户id -->
									<table>
										<tr>
											<td>
											...
											<td>
												...
												<input type="hidden" name="picture" value="${ma.picture}" />
											</td>
										</tr>
										<tr>
											<td>
											...
											<td align="right">
												<input type="text" name="username" value="${ma.username }">
											</td>
										...
										<tr>
											...
											<td align="right">
												<input type="text" name="name" value="${ma.name }">
											</td>
										...
										<tr>
											...
											<td>
												<c:forEach items="${typeList}" var="c">
														...
														<input type="radio" name="sex" value="${c.myKey}" checked>${c.myValue}
										...
										<tr>
											...
											<td align="right">
												<input type="text" name="age" value="${ma.age }" />
											</td>
										...
										<tr>
											...
											<td align="right">
												<input type="text" name="phone" value="${ma.phone }" />
											</td>
										...
										<tr>
											...
											<td align="right">
												<input type="text" name="mail" value="${ma.e_mail}" />
											</td>
