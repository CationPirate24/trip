      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            <h2 class="margin-bottom-10">查看用户信息</h2>
            <p>Here goes another form and form controls.</p>
            <form action="managerUser/find.do" class="templatemo-login-form" method="post">
              
              <div class="row form-group">
                <div class="col-lg-12 has-success form-group">                  
                    <label class="control-label" for="inputWithSuccess">姓名：${ma.name}</label>
                </div>
              </div>
              <div class="row form-group">
                <div class="col-lg-12 has-warning form-group">                  
                    <label class="control-label" for="inputWithWarning">年龄：${ma.age}</label>
                </div>
              </div>
              <div class="row form-group">
                <div class="col-lg-12 has-error form-group">                  
                    <label class="control-label" for="inputWithError">性别：${maSex}</label>
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-lg-12 has-success form-group">                   
                    <div class="margin-right-15 templatemo-inline-block">
                      <label class="control-label" for="inputWithSuccess">邮箱：${ma.e_mail}</label>
                    </div>
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-lg-12 has-warning form-group">                   
                    <label class="control-label" for="inputWithWarning">电话：${ma.phone}</label>
                </div>
              </div>
